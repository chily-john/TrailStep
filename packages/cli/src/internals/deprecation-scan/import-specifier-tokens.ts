...
// "@stepkit/core" or "@stepkit/sdk" in a workflow's source text and returns each imported symbol's
...
const IMPORT_CLAUSE_PATTERN = /import\s*\{([\s\S]*?)\}\s*from\s*["'](@stepkit\/(?:core|sdk))["']/gu;
