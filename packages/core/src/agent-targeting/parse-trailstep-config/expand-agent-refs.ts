...
export function expandAgentRefs(options: {
  ...
  const expandedAgents: Record<string, readonly TrailStepAgentTarget[]> = {};
  const memo = new Map<string, readonly TrailStepAgentTarget[]>();
...
function expandTopLevelAgent(options: {
  ...
  readonly agents: RawTrailStepAgentMappings;
  readonly memo: Map<string, readonly TrailStepAgentTarget[]>;
...
function expandTargetArray(options: {
  ...
  readonly targets: readonly RawTrailStepAgentTarget[];
  readonly agents: RawTrailStepAgentMappings;
  readonly memo: Map<string, readonly TrailStepAgentTarget[]>;
  readonly stack: readonly string[];
  readonly rootRefPath: string | undefined;
