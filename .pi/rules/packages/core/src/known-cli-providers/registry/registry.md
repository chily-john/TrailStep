...
- Provider working requests receive prepared file paths, optional model/thinking values, and abort signals; interactive requests receive prompt/system-prompt-file inputs plus optional model/thinking values, environment variables, and abort signals; providers decide whether stdout parsing or vendor file output is appropriate.
